    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <form action="<?php echo e(url('update_student', $student->id)); ?>" method="post">                    <?php echo csrf_field(); ?>

                    <!-- First Name -->
                    <div class="mb-3">
                        <label for="First Name" class="form-label" for="first_name">First Name</label>
                        <input type="text" value="<?php echo e($student->first_name); ?>" class="form-control" id="first_name" name="first_name">                    </div>

                    <!-- Last Name -->
                    <div class="mb-3">
                        <label for="Last Name" class="form-label" for="last_name">Last Name</label>
                        <input type="text" value="<?php echo e($student->last_name); ?>" class="form-control" id="last_name" name="last_name">                    </div>
...
<?php /**PATH C:\xampp\htdocs\laravel-demo-2023-10-08-master\laravel-demo-2023-10-08-master\resources\views/student/edit.blade.php ENDPATH**/ ?>